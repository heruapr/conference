...
<html lang="en" dir="ltr">
  <head>
<link rel="shortcut icon" href="img/isyg.png" />
  ...
  <a class="navbar-brand" href=""><img src="img/isyg.png" height="50" width="150"></img></a>
...
WHERE {
  ...
  ?Conference conf:name ?confName
          ...
          foreach ($result as $loop) {
               ...
               if($loop['confName']['value']=="International Symposium On Geoinformatics 2018"){
