...
<html lang="en" dir="ltr">
  <head>
<link rel="shortcut icon" href="img/logo-siet 2018.png" />
  ...
  <a class="navbar-brand" href=""><img src="img/logo-siet 2018.png" height="50" width="150"></img></a>
...
WHERE {
  ...
  ?Conference conf:name ?confName
          ...
          foreach ($result as $loop) {
               if($loop['confName']['value']=="Sustainable Information Engineering and Technology"){
